...
def start_service():
    ...
    goals[0].target_pose.pose.position.x = -1;
    goals[0].target_pose.pose.position.y = -0.45;
    goals[1].target_pose.pose.position.x = 0.2
    goals[1].target_pose.pose.position.y = -2;
    goals[2].target_pose.pose.position.x = 2.9;
    goals[2].target_pose.pose.position.y = -1.6;
    goals[3].target_pose.pose.position.x = -1.6;
    goals[3].target_pose.pose.position.y = 1.65;
